...
const char * const BITCOIN_CONF_FILENAME = "coinua.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\CoinUA
    // macOS: ~/Library/Application Support/CoinUA
    // Unix-like: ~/.coinua
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CoinUA";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/CoinUA";
#else
    // Unix-like
    return pathRet / ".coinua";
#endif
#endif
}
