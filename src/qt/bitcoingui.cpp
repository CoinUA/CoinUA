...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CoinUA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coinua: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CoinUA addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CoinUA addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file..."), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed CoinUA Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from clipboard..."), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed CoinUA Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a coinua: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible CoinUA command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to CoinUA network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
