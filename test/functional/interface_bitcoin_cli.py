...
# The block reward of coinbaseoutput.nValue (50) CUA/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 CUA/block.
BLOCKS = 101
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # Mine a block to confirm; adds a block reward (50 CUA) to the default wallet.
