...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " coinua-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  coinua-tx [options] <hex-tx> [commands]  Update hex-encoded coinua transaction\n" +
            "or:     coinua-tx [options] -create [commands]   Create hex-encoded coinua transaction\n" +
            "\n";
