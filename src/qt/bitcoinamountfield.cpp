...
public:
    ...
    QSize minimumSizeHint() const override
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::CUA, BitcoinUnits::maxMoney(), false, BitcoinUnits::SeparatorStyle::ALWAYS));
...
private:
    int currentUnit{BitcoinUnits::CUA};
