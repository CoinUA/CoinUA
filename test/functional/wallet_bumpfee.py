...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "CUA/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 CUA / 1000 vbytes = 0.00049385 CUA.
    # or occasionally 140 vbytes * fee_rate 0.00350250 CUA / 1000 vbytes = 0.00049035 CUA.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 CUA.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 CUA / 1000 vbytes = 0.00002820 CUA
