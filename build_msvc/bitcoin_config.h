...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The CoinUA Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "CoinUA Core"
...
#define PACKAGE_NAME "CoinUA Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CoinUA Core 0.21.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coinua"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://coinuacore.net/"
