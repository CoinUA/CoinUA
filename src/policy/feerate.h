...
const std::string CURRENCY_UNIT = "CUA"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    CUA_KVB,      //!< Use CUA/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from CUA/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::CUA_KVB) const;
